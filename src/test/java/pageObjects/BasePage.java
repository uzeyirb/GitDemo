...
public class BasePage extends DriverFactory {
	...
	public static void captureScreenshot() throws IOException, InterruptedException {
		...
		screenshotName = returnDateStamp(".jpg");  //private static String screenshotName; do not forget to add this as class level variable
	...
	public static void copyLatestExtentReport() throws IOException {
		...
		File dest = new File(System.getProperty("user.dir") + "\\output\\"+"report_" + date.toString() + ".html");
